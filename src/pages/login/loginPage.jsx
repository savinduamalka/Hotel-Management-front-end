      ...
      <div className="w-[450px]  bg-white bg-opacity-20 backdrop-blur-lg rounded-lg p-10 shadow-lg">
        ...
        <form className="flex flex-col items-center space-y-5">
          <input
            type="email"
            placeholder="Email"
            className="w-full px-4 py-3 text-[#7E60BF] bg-[#FEF9F2] bg-opacity-80 border border-[#E4B1F0] rounded focus:outline-none focus:ring-2 focus:ring-[#7E60BF] focus:border-transparent" defaultValue={email}
            onChange={
                (e) => {
